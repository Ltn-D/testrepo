...
public class Lecture6_4 {
    ...
    static public Instant plusMinutes(Instant instant, long minutes) {
        Instant minut = instant.plus(minutes, ChronoUnit.MINUTES);
    ...
    static public Instant plusDays(Instant instant, long days) {
        return instant.plus(days, ChronoUnit.DAYS); //напишите тут ваш код
    }

    static public Instant minusMinutes(Instant instant, long minutes) {
        return instant.minus(minutes, ChronoUnit.MINUTES);//напишите тут ваш код
    }
