...
public class Lecture6_2 { private static final int FRIDAY = 5;
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        ...
        boolean isWeekend = dayOfWeek == SATURDAY ||(dayOfWeek == FRIDAY&&time >=WEEKEND_START_FRIDAY_CUT_OFF_HOUR)||(dayOfWeek == SUNDAY&&time <WEEKEND_END_SUNDAY_CUT_OFF_HOUR);
